...
import jp.kt.balancebook.databinding.FragmentStatsTabItemExpendBinding;


public class StatsTabItemExpendFragment extends Fragment {

    private FragmentStatsTabItemExpendBinding mBinding;
    private PieChart mPieChart;
    private int mChartLabelColor, mChartColor01, mChartColor02, mChartColor03;

    public StatsTabItemExpendFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = FragmentStatsTabItemExpendBinding.inflate(inflater, container, false);
